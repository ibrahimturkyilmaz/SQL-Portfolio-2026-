...
EXEC msdb.dbo.sysmail_add_account_sp
    ...
    @email_address = '',  -- <--- BURAYI DEÐÝÞTÝR
    @display_name = 'SQL Server Robotu',
    @mailserver_name = 'smtp.gmail.com',
    @port = 587,
    @enable_ssl = 1,
    @username = '',       -- <--- BURAYI DEÐÝÞTÝR
    @password = '';          -- <--- GMAIL UYGULAMA ÞÝFRESÝ
...
EXEC msdb.dbo.sp_send_dbmail
    @profile_name = 'SirketBildirimProfili',
    @recipients = '', -- Kendi mailine gönder
...
BEGIN
    ...
    BEGIN
        ...
        EXEC msdb.dbo.sp_send_dbmail
            @profile_name = 'SirketBildirimProfili',
            @recipients = '', -- CEO'nun mail adresi (Senin mailin olsun þimdilik)
